package com.ramonmr95.tiky.olc.security.jwt;
...
public class JwtUtils {
	...
	@Value("${jwt.token.secretExpirationMs}")
	...
	public String getExpirationFromJwtToken(String token) {
		return Jwts.parser().setSigningKey(jwtSecret).parseClaimsJws(token).getBody().getExpiration().toString();
	}
	
	public String getIssuedAtFromJwtToken(String token) {
